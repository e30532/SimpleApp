 ...
 * generated in the simple.cxf package. 
...
public class ObjectFactory {
    ...
    private final static QName _SayResponse_QNAME = new QName("http://cxf.simple/", "sayResponse");
    private final static QName _Say_QNAME = new QName("http://cxf.simple/", "say");

    /**
     * Create a new ObjectFactory that can be used to create new instances of schema derived classes for package: simple.cxf
     * 
     */
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://cxf.simple/", name = "sayResponse")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://cxf.simple/", name = "say")
