 ...
 * 
 */
@WebServiceClient(name = "HelloService", targetNamespace = "http://server.jaxws.simple/", wsdlLocation = "WEB-INF/wsdl/HelloService.wsdl")
    ...
    extends Service
{
    ...
    private final static QName HELLOSERVICE_QNAME = new QName("http://server.jaxws.simple/", "HelloService");

    static {
            HELLOSERVICE_WSDL_LOCATION = simple.jaxws.server.HelloService.class.getResource("/WEB-INF/wsdl/HelloService.wsdl");
    ...
    public Hello getHelloPort() {
        return super.getPort(new QName("http://server.jaxws.simple/", "HelloPort"), Hello.class);
    }
    ...
    public Hello getHelloPort(WebServiceFeature... features) {
        return super.getPort(new QName("http://server.jaxws.simple/", "HelloPort"), Hello.class, features);
    }
