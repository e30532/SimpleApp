...
@WebServiceClient(name = "HelloService", targetNamespace = "http://jms.soap.simple/", wsdlLocation = "WEB-INF/wsdl/HelloService.wsdl")
    ...
    extends Service
{
    ...
    private final static QName HELLOSERVICE_QNAME = new QName("http://jms.soap.simple/", "HelloService");

    static {
            HELLOSERVICE_WSDL_LOCATION = simple.soap.jms.HelloService.class.getResource("/WEB-INF/wsdl/HelloService.wsdl");
    ...
    public Hello getHelloPort() {
        return super.getPort(new QName("http://jms.soap.simple/", "HelloPort"), Hello.class);
    }
    ...
    public Hello getHelloPort(WebServiceFeature... features) {
        return super.getPort(new QName("http://jms.soap.simple/", "HelloPort"), Hello.class, features);
    }
